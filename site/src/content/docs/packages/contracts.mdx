...
description: "IO boundaries (checked fetch responses, parsed boundary data), error taxonomy, schema and wire naming, env access, money precision and translation keys."
sidebar:
  label: contracts
  order: 4
---
